...
{
   //  Set window title
   setWindowTitle(tr("hw07: Image Processing by Dmitriy Tarasov"));
...
// camera->setCaptureMode(QCamera::CaptureStillImage);
   ...
   //shader->addItem("GaussianBlur");
   shader->addItem("InvertColors");
   shader->addItem("Vigette");
   shader->addItem("Mix");
   shader->addItem("Displacement");
   shader->addItem("OldTV");
   //shader->addItem("Swirl");
